...
if __name__ == "__main__":
    ...
    flags.DEFINE_integer("num_classes", 4716, "num_classes: a positive integer for the number of classes.")
    # Model flags.
    flags.DEFINE_bool(
        ...
        with sv.managed_session(target, config=self.config) as sess:
            ...
            try:
                ...
                while (not sv.should_stop()) and (not self.max_steps_reached):
                    ...
                    print("global_step/max_steps:", global_step_val, "/", self.max_steps)
